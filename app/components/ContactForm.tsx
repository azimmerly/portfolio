  ...
  return (
    ...
    >
      ...
      <input
        ...
        className="mb-3.5 w-full resize-none rounded-lg border-2 border-solid border-transparent bg-zinc-100 p-2 outline-hidden transition focus:border-zinc-800 active:border-zinc-800"
      />
